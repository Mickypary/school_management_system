                           ...
                           <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="name" name="name" value="{{ old('name') }}" type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="email" name="email" value="{{ old('email') }}" type="email" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
