					...
					<form method="POST" action="{{ route('update.assign.subject', $editData[0]->class_id) }}">
					  ...
					  <div class="row">
						...
						<div class="add_item">
									...
									<div class="row">
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" value="{{ $edit->full_mark, old('amount') }}" name="full_mark[]" class="form-control"> 
												</div>
											</div>
										</div>   <!-- End Col-MD-5 -->
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" value="{{ $edit->pass_mark, old('pass_mark') }}" name="pass_mark[]" class="form-control"> 
												</div>
											</div>
										</div>   <!-- End Col-MD-5 -->
										...
										<div class="col-md-2">
											<div class="form-group">
												...
												<div class="controls">
													<input type="text" value="{{ $edit->subjective_mark, old('subjective_mark') }}" name="subjective_mark[]" class="form-control"> 
												</div>
											</div>
										</div>   <!-- End Col-MD-5 -->
								...
								</div>   <!-- End Remove Delete Javascript -->
									@endforeach
		  			...
		  			<div class="form-row">
						...
						<div class="col-md-2">
							<div class="form-group">
								<h5>Full Mark <span class="text-danger">*</span></h5>
								<div class="controls">
									<input type="text" value="{{ old('amount') }}" name="full_mark[]" class="form-control"> 
								</div>
							</div>
						</div>   <!-- End Col-MD-5 -->
