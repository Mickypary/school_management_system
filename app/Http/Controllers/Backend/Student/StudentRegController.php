...
class StudentRegController extends Controller
{
    public function StudentRegView()
    {
        ...
        $data['student_year'] = StudentYear::all();
    ...
    public function StudentRegStore(Request $request)
    {
        ...
        DB::transaction(function() use($request) {
            ...
            $student = User::where('usertype', 'Student')->orderBy('id', 'Desc')->first();
                ...
                $final_id_no = 'GVS-STU'.$checkYear.$id_no;
                $user = new User();
                $code = rand(0000,9999);
    ...
    public function StudentRegEdit($student_id)
    {
        ...
        $data['editData'] = AssignStudent::with(['student','student_year','student_class','discount'])->where('student_id', $student_id)->first();
    ...
    public function StudentUpdatePromotion(Request $request, $student_id)
    {
        ...
        $notification = array(
            'message' => 'Student Promotion was Successful',
            'alert-type' => 'info',
        );
    ...
    {
        $data['details'] = AssignStudent::with(['student','student_year','student_class','discount'])->where('student_id', $student_id)->first();
        // dd($data['details']);
